...
start_time=$(date +%s)
config_path="/srv/dev-disk-by-label-Storage1/Config/Plex/"
config_backup_path="/srv/dev-disk-by-label-Storage1/Backups/duplicati/plex/config.tgz"
